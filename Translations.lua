Config.Languages = {
	...
	['notvalidpet'] = "¡RUH ROH! Se detectó un modelo de personaje incorrecto 🐕",
	['animaldisabled'] = "¡Lo siento! Los emotes de animales están desactivados en este servidor",
	['adultemotedisabled'] = "¡Bonk! Emotes para adultos desactivados 🔞",
	['toggle_instructions'] = "Alternar las instrucciones",
	['exit_binoculars'] = "Salir de los binoculares",
	['toggle_binoculars_vision'] = "Alternar entre los modos de visión",
	['exit_news'] = "Salir de la cámara de noticias",
	['toggle_news_vision'] = "Alternar entre los modos de visión",
	['edit_values_newscam'] = "Editar el texto de noticias",
	['not_in_a_vehicle'] = "No puedes reproducir esta animación mientras estás en un vehículo",
	['in_a_vehicle'] = "Solo puedes reproducir esta animación mientras estás en un vehículo 🚷",
	['no_anim_crawling'] = "No puedes reproducir animaciones mientras estás gateando"
    },
    ['sv'] = { -- Swedish 🇸🇪
        ['emotes'] = 'Emotes 🎬',
